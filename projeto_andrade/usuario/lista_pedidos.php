...
<head>
    ...
    <title>Lista de Pedidos - Yukihira</title>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><button id="botao_pedir" name="idpedido" value="<?php echo $lista["idpedido"] ?>" class="btn btn-primary">Alterar Pedido</button></td>
                                                </form>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
