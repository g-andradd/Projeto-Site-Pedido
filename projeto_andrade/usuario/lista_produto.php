...
<head>
    ...
    <title>Lista de Produtos - Yukihira</title>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php
                                        while ($lista = $consulta_produto->fetch(PDO::FETCH_ASSOC)) {
                                        ?>
                                            <tr>
                                                <form action="alterar_produto.php" method="POST">
                                                    <td><input type="hidden" name="classe_produto" value="<?php echo $lista["classe_produto"] ?>"> <?php echo $lista["classe_produto"] ?> </td>
                                                    <td><input type="hidden" name="nome_produto" value="<?php echo $lista["nome_produto"] ?>"> <?php echo $lista["nome_produto"] ?> </td>
                                                    <td><input type="hidden" name="valor_produto" value="<?php echo $lista["valor_produto"] ?>"> <?php echo $lista["valor_produto"] ?> </td>
                                                    <td><input type="hidden" name="descricao_produto" value="<?php echo $lista["descricao_produto"] ?>"> <?php echo $lista["descricao_produto"] ?> </td>
                                                    <td><input type="hidden" name="img_produto" value="<?php echo $lista["img_produto"] ?>"> <?php echo $lista["img_produto"] ?> </td>
                                                    <td><input type="hidden" name="tipo_img" value="<?php echo $lista["tipo_img"] ?>"> <?php echo $lista["tipo_img"] ?> </td>
                                                    <td><button id="botao_pedir" name="idproduto" value="<?php echo $lista["idproduto"] ?>" class="btn btn-primary">Alterar Produto</button></td>
                                                </form>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
