...
$consulta_cliente = $conexao->query("SELECT * FROM `cliente` WHERE idcliente = $idcliente");
                                    ...
                                    ?>
                                        <tr>
                                            <form action="alterar_conta.php" method="POST">
                                                ...
                                                <td><button id="botao_pedir" name="idcliente" value="<?php echo $lista["idcliente"] ?>" class="btn btn-primary">Alterar Conta</button></td>
                                            </form>
                                        </tr>
                                    <?php } ?>
                                </tbody>
